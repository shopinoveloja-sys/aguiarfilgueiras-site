...
export default function Profile() {
  ...
  return (
    <div className="min-h-screen bg-[#0b0f19] text-white pb-24">
      <header className="sticky top-0 z-50 bg-[#0b0f19]/80 backdrop-blur-md border-b border-emerald-500/10 px-4 py-3 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <button onClick={() => navigate("/dashboard")} className="p-2 rounded-lg hover:bg-white/5">
            <span className="material-symbols-outlined text-emerald-500">arrow_back</span>
          </button>
      ...
      <main className="p-6 space-y-6">
        <section className="flex flex-col items-center text-center space-y-4">
          <div className="relative">
            <div className="w-32 h-32 rounded-full border-4 border-emerald-500/20 p-1 bg-gradient-to-tr from-emerald-800 to-emerald-500">
              {sessionUser?.avatarUrl ? (
                <img alt="Foto do perfil" src={sessionUser.avatarUrl} className="w-full h-full rounded-full object-cover bg-[#161e2e]" />
              ) : (
                <div className="w-full h-full rounded-full bg-[#161e2e] flex items-center justify-center text-4xl font-black text-emerald-300">
                  {userInitial}
                </div>
              )}
            </div>
          ...
          <div className="grid grid-cols-2 gap-3 w-full max-w-xs">
            <button
              ...
              className="rounded-xl border border-emerald-500/20 bg-emerald-500/10 px-4 py-3 text-sm font-bold text-emerald-200 active:scale-95"
            >
              Editar perfil
            </button>
            <button
        ...
        {editingProfile && (
          <section className="rounded-xl border border-emerald-500/10 bg-[#1f2a3d66] p-5 space-y-4">
            ...
            <label className="block space-y-2">
              ...
              <input
                ...
                className="w-full rounded-xl border border-emerald-500/20 bg-[#161e2e] p-3 text-sm outline-none focus:border-emerald-500"
            ...
            <label className="block space-y-2">
              ...
              <input
                ...
                className="w-full rounded-xl border border-emerald-500/20 bg-[#161e2e] p-3 text-sm text-slate-300"
              />
            </label>
            {profileAvatar ? (
        ...
        <section className="grid grid-cols-2 gap-4">
          <button onClick={() => navigate("/vehicle")} className="flex flex-col items-start p-5 rounded-xl bg-[#1f2a3d66] border border-emerald-500/10 hover:bg-emerald-500/5 transition-colors text-left space-y-3">
          ...
          <button onClick={() => navigate("/earnings")} className="flex flex-col items-start p-5 rounded-xl bg-[#1f2a3d66] border border-emerald-500/10 hover:bg-emerald-500/5 transition-colors text-left space-y-3">
            <div className="bg-emerald-500/10 p-2 rounded-lg">
          ...
          <button onClick={() => navigate("/calendar")} className="col-span-2 flex items-center p-5 rounded-xl bg-[#1f2a3d66] border border-emerald-500/10 hover:bg-emerald-500/5 transition-colors text-left gap-4">
        ...
        {referrals && (
          <section id="partner-panel" className="bg-slate-900 border border-slate-800 rounded-xl p-4 space-y-4">
            ...
            {!referrals.eligible ? (
              ...
              <>
                <div className="bg-[#161e2e] border border-emerald-500/10 rounded-xl p-3">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="bg-[#161e2e] rounded-xl p-3">
                  ...
                  <div className="bg-[#161e2e] rounded-xl p-3">
                    ...
                    <p className="text-2xl font-black text-emerald-300">{referrals.secondLevelConversions}</p>
                  </div>
                  <div className="bg-[#161e2e] rounded-xl p-3">
                ...
                <div className="bg-[#161e2e] border border-slate-800 rounded-xl p-4 space-y-3">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    ...
                    <div className="bg-slate-950/50 rounded-xl p-3 text-center">
                      ...
                      <p className="text-sm font-black text-emerald-300">{formatMoneyPrecise(referrals.paidAmount)}</p>
                    </div>
                  </div>
        ...
        <section className="bg-[#1f2a3d66] rounded-xl p-6 border border-emerald-500/10 space-y-4">
          <h4 className="text-[10px] font-bold tracking-wider uppercase text-emerald-500">Performance Rapida</h4>
        ...
        <button onClick={() => document.getElementById("partner-panel")?.scrollIntoView({ behavior: "smooth" })} className="w-full flex items-center gap-4 p-4 rounded-xl bg-[#1f2a3d66] border border-emerald-500/10 hover:bg-emerald-500/5 transition-colors">
          <div className="bg-emerald-500/10 p-2 rounded-lg">
      ...
      <nav className="fixed bottom-0 left-0 right-0 bg-[#1f2a3d66] border-t border-emerald-500/10 px-6 py-3 pb-8 flex items-center justify-around">
        ...
        <a className="flex flex-col items-center justify-center bg-gradient-to-br from-emerald-800 to-emerald-500 text-white rounded-xl px-3 py-1.5 shadow-lg" href="#" onClick={(e) => { e.preventDefault(); navigate("/profile"); }}>
